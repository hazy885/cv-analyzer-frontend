  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className={`p-5 rounded-xl ${darkMode ? 'bg-gray-700/50 border border-gray-600' : 'bg-blue-50/80 border border-blue-200'}`}>
            ...
            <tbody>
              <tr className={`${darkMode ? 'border-gray-700' : 'border-gray-200'} border-b`}>
                ...
                <td className="text-center">
                  <input type="checkbox" defaultChecked className={`rounded text-blue-600 ${darkMode ? 'bg-gray-700 border-gray-600' : ''}`} />
                </td>
                <td className="text-center">
                  <input type="checkbox" defaultChecked className={`rounded text-blue-600 ${darkMode ? 'bg-gray-700 border-gray-600' : ''}`} />
                </td>
                <td className="text-center">
                  <input type="checkbox" className={`rounded text-blue-600 ${darkMode ? 'bg-gray-700 border-gray-600' : ''}`} />
                </td>
              </tr>
              <tr className={`${darkMode ? 'border-gray-700' : 'border-gray-200'} border-b`}>
